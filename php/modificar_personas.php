...
echo "<th class='registros__th'>Cédula</th>";
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo "<td class='registros__td'>" . htmlspecialchars($row['nombre']) . "</td>";
    echo "<td class='registros__td'>" . htmlspecialchars($row['apellido']) . "</td>";
    echo "<td class='registros__td'>" . htmlspecialchars($row['cedula']) . "</td>";
