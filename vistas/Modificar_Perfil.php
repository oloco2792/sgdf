...
<form class="registro FormularioAjax" method="POST" action="./php/modificar_perfil.php" autocomplete="off">
        
        <input class="activarInput" type="hidden" name="sesion" value="<?=$sesion?>" pattern="[a-zA-Z0-9]{4, 20}" maxlength="40">
